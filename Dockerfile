...
COPY anomaly_rules.py detect_anomalies.py crowd_analysis_protocol.py crowd_analysis_server.py crowd_counter.py object_analysis_server.py ./
...
ENV PYTHONUNBUFFERED=1 \
    ...
    OBJECT_MODEL_PATH=/app/result/models/yolov8n.onnx \
    OBJECT_DEVICE_ID=0 \
